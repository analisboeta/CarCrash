...
public final class Field {
    ...
    public static int width; // tenho a partida o tamanho do campo e sao estaticas
    ...
    public static void draw(Car[] cars) {
        ...
        for (Car c : cars) {
            ...
            if (!c.isCrashed()) {
                screenWriter.drawString(c.getPos().getCol(),
                        c.getPos().getRow(),
                        c.toString());
            } else {
                screen.putString(c.getPos().getCol(),
                        c.getPos().getRow(), c.toString(),
